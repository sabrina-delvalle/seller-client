  ...
  return (
    <div>
        ...
        }
        {
            ...
            </div>:loading?<div data-aos="zoom-in">
                        <ThreeDots 
                            height="60" 
                            width="60" 
                            radius="9"
        ...
        <div className="p-10 hover:scale-105 ease-in duration-300">
        {
            ...
            <ul data-aos="zoom-in" className="flex flex-row bg-slate-600/10 rounded-xl p-8 justify-center items-start text-neutral-500 shadow-xl cursor-pointer">
                <div data-aos="fade-right" className="pr-3">
                    ...
                    <li className="p-2"><svg className="h-6 w-6 text-gray-500"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round">  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />  <polyline points="22,6 12,13 2,6" /></svg></li>
                    <li className="p-2"><svg className="h-6 w-6 text-gray-500"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
