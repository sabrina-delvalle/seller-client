...
export default function Footer() {
  return (<div className="h-52 w-full bg-neutral-800 flex items-center justify-center">
  <div className="flex flex-col align-middle items-center text-white text-lg max-sm:flex max-sm:flex-col max-sm:justify-center max-sm:items-center">
