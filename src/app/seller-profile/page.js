...
function backMain() {
  ...
  return (
    <div className="font-sans">
      ...
      <div className="grid grid-rows-6 bg-neutral text-white col-span-2 bg-building-bg bg-center bg-cover">
        <p className="grid justify-items-center content-center row-span-1 bg-neutral-300/30"><a href="https://www.pieroliventi.com/" target="_blank"><Image
          src={white_logo}
          alt="css_profile"
          width={180}
          height={180}
        ...
        /></a></p>
        <div className="row-span-5 flex items-center justify-center bg-neutral-300/30 hover:bg-neutral-200/30 hover:cursor-pointer" onClick={backMain}><svg className="h-16 w-16 text-white hover:cursor-pointer"  width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <path d="M9 13l-4 -4l4 -4m-4 4h11a4 4 0 0 1 0 8h-1" /></svg></div>
      </div>
      <div className="grid col-span-10 grid-cols-1 grid-rows-6">
        <div className="flex items-center justify-center row-span-1 col-span-1 text-neutral-600 bg-white">   
        {/* //dropdown menu */}         
        <div>
              <label htmlFor="company-list"></label>
              <select name="company" id="company-list" className="h-14 mt-20 px-80 rounded-sm text-lg shadow-xl outline-none focus:border-neutral-300 focus:border text-white text-center placeholder-neutral-300 hover:bg-sky-200 hover:cursor-pointer hover:text-white focus:text-white bg-building-bg bg-center opacity-90" onChange={selectCompany}>
        ...
        { isCompany ? 
        <div className="grid row-span-6 justify-items-center">
        <h1 className="flex items-center justify-center row-span-3 text-neutral-900 text-5xl mt-20 p-7 opacity-80 font-semibold">{company.company_name}</h1>
        <p className="-p-5 text-neutral-500">
        ─────────────────────────
        </p>
          <div className="flex flex-col items-start text-gray-800 bg-gray-100 my-20 w-auto rounded-3xl -pt-3 px-9 shadow-xl opacity-70">
            <div className="flex flex-row items-center justify-start">
              <div className="flex flex-row items-center justify-center p-2 ml-6"><svg className="h-10 w-10 text-gray-500"  width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <circle cx="12" cy="7" r="4" />  <path d="M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" /></svg></div>
              <div className="flex items-start text-2xl font-light pl-8">{company.first_name} {company.last_name}</div>
            </div>
            <div className="flex flex-row items-center justify-start p-2  ml-6">
              <div className="grid justify-items-center content-center col-span-1"><svg className="h-10 w-10 text-gray-500"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
            </svg></div>
              <div className="flex items-start text-2xl font-light pl-10">{company.address}</div>
            </div>
            <div className="flex flex-row items-center justify-start p-2  ml-6">
              <div className="grid justify-items-center content-center col-span-1"><svg className="h-10 w-10 text-gray-500"  width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <path d="M21 3L14.5 21a.55 .55 0 0 1 -1 0L10 14L3 10.5a.55 .55 0 0 1 0 -1L21 3" /></svg></div>
              <div className="flex items-start text-2xl font-light pl-10">{company.county} {company.city} {company.state}</div>
            </div>
            <div className="flex flex-row items-center justify-start p-2  ml-6">
              ...
              <div className="flex items-start text-2xl font-light pl-10">{company.zip}</div>
            </div>
            <div className="flex flex-row items-center justify-start p-2  ml-6">
              <div className="grid justify-items-center content-center col-span-1"><svg className="h-10 w-10 text-gray-500"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round">  <rect x="5" y="2" width="14" height="20" rx="2" ry="2" />  <line x1="12" y1="18" x2="12.01" y2="18" /></svg></div>
              <div className="flex items-start text-2xl font-light pl-10">{company.phone1}/{company.phone2}</div>
            </div>
            <div className="flex flex-row items-center justify-start p-2  ml-6">
              <div className="grid justify-items-center content-center col-span-1"><svg className="h-10 w-10 text-gray-500"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round">  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />  <polyline points="22,6 12,13 2,6" /></svg></div>
              <div className="flex items-start text-2xl font-light pl-10">{company.email}</div>
            </div>
            <div className="flex flex-row items-center justify-start p-2  ml-6">
              ...
              <div className="flex items-start text-2xl font-light pl-10">{company.web}</div>
            </div>
          </div>
        </div>
        : 
